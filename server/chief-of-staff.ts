...
export function agentsCommsPrompt(opts?: { fullAutonomy?: boolean }): string {
  return (
    ...
    " list_bots shows the other bots." +
    " If tools are deferred or namespaced, discover the native agents tools before declaring them unavailable." +
    ...
    " update_bot renames a bot or changes its title/description. To update yourself, pass bot_id: self; no lookup or user-supplied ID is needed." +
