...
| `electron/` | Desktop shell: dictation, screen capture, local computer-use daemon, user-session harness attach. macOS-only helpers (dictation, TCC) stay gated; local CUA is darwin + win32. Linux systemd is not a ship target. |
